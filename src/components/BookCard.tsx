...
export const BookCard = ({ item }: { item: Book }) => {
  ...
  return (
    <div className="flex flex-col justify-between bg-white shadow-md rounded-md p-3 border border-gray-200 hover:shadow-lg transition-shadow duration-200 w-40">
    <img
        src={thumbnail}
        alt={`${title} cover`}
